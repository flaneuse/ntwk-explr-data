...
def get_nodes(query = 'MATCH (n) RETURN *', url = '52.87.232.110', port = '7688', username = "neo4j", pw = "sulabngly1testing"):
    # run query
    result = query_neo4j(query, url = '52.87.232.110', port = '7688', username = "neo4j", pw = "sulabngly1testing")

    # parse query results
    nodes = parseNode(result)
    return nodes
